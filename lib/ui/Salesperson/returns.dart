...
class _Summary extends State<Returns> {
  var productData = [
    {
      'title': "Title1",
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text('returns'.tr(),style: FCITextStyle().bold20(),),
                  ),
                ],
              ),
              Expanded(
        ...
        children: [
          Row(
            ...
            children: [
              Row(
                children: [
                  Icon(Icons.watch_later_outlined,size: ScreenUtil().setSp(20),color: Colors.grey),
                  Padding(
